...
2. Epochs of 50~70 should be good. For cross-subject consistency, lower epochs is preferred as the model reaches minima relatively quickly (prevent overfitting).
